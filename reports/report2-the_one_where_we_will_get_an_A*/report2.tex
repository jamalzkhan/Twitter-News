...
\begin{document} 
  ...
  \begin{itemize}
   ...
   \item The UI needs to be fluid and updating in real-time and on its own - the user should not be force to hit a refresh button at all. It should also be fun to look at.
  \end{itemize}
  ...
  \begin{itemize}
   ...
   \item Displaying the general approval of the story. We can measure wether a tweet is positive or negative towards the topic (this is called \emph{sentiment analysis}) and we want to use these measurements to tell users wether the reaction to the news story is positive or negative.
  \end{itemize}
  ...
  \begin{description}
   ...
   \begin{itemize}
     \item Add the ability to analyse wether the tweets are positive or negative and present the aggregated result in the UI.
