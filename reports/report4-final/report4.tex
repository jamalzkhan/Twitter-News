...
\begin{document} 
	...
	\paragraph{Architecture} This is the basic sequence of events that happens in the analysis process:
		\begin{enumerate}
		  ...
		  \item \emph{News Fetcher} generates keywords using AlchemyAPI
		  \item \emph{News Fetcher} saves all the info generated into \emph{shared} and goest o sleep for 500s
		  ...
		  \item \emph{Analysis} performs sentiment analysis on the tweets attached to stories using Twitter Sentiment mentioned earlier
		\end{enumerate}
